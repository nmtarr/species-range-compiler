...
"""
group_name = "American Marten Range"
sp_code = "mAMMAx"
range_db = "C:/Workspaces/RangeMaps/mAMMAx/mAMMAxGen2.sqlite"
...
node_subgroup1 = node_group1.addGroup("YEAR_ROUND RANGE")
...
for period in [2025, 2020, 2015, 2010, 2005]:
    ...
    # Add categories
    cat_colors = {'1': '100,21,39,255','2': '131,19,56,255',
                  '3': '192,50,98,255', '4': '212,206,185,255',
                  '5': '183,173,139,255'}
    cat_colors = {'1': '1,102,94,255','2': '90,180,172,255',
                  '3': '199,234,229,255', '4': '246,232,195,255',
                  '5': '216,179,101,255'}
