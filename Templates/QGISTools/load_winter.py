...
node_subgroup1 = node_group1.addGroup("WINTER RANGE")
...
for period in [2025, 2020, 2015, 2010, 2005]:
    ...
    # Add categories
    cat_colors = {'1': '49,130,189,255','2': '158,202,225,255',
                  '3': '222,235,247,255', '4': '150,150,150,255',
                  '5': '99,99,99,255'}
